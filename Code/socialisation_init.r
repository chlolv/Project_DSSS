...
path = file.path(paste0(data_ori, "gardienspaixq1.sav"))
init = read.spss(path)

path2 = file.path(paste0(data_ori, "gardienspaixq2.sav"))
...
#---------- Retrouver les identifiants manquants ----------#
ident1 <- wave1$CIDENTIT
ident2 <- wave2$CIDENTIT

summary(ident1)
summary(ident2)

missing_ident <- cbind(ident1, ident2)
